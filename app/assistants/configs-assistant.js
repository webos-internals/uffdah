...
ConfigsAssistant.prototype.setup = function()
{
	...
	this.controller.get('headerTitle').innerHTML = $L("Storage");		
...
ConfigsAssistant.prototype.onFeeds = function(payload)
{
	try 
	{
		...
		else if (payload.errorCode != undefined) 
		{
			...
			{
				this.alertMessage('Preware', $L("The service is not running. First try restarting Preware, or reboot your phone and try again."));
				this.doneLoading();
			}
			else
			{
